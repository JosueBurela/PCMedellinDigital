...
with open(r'C:\Users\burel\Downloads\Practica_Recopilacion_Evaluacion_Datos.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=2, ensure_ascii=False)

with open('Practica_Ciencia_Datos/Practica_Recopilacion_Evaluacion_Datos.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=2, ensure_ascii=False)

print("Notebook Jupyter .ipynb generado exitosamente en Downloads y localmente.")
