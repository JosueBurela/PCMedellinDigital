...
urlpatterns = [
    ...
    # Módulo Intranet: Control Administrativo de Flotilla
    path('intranet/flotilla/', views.admin_vehiculos_dashboard, name='admin_vehiculos_dashboard'),
    path('intranet/flotilla/unidad/crear/', views.crear_unidad, name='crear_unidad'),
    path('intranet/flotilla/unidad/editar/<int:unidad_id>/', views.editar_unidad, name='editar_unidad'),
    path('intranet/flotilla/unidad/eliminar/<int:unidad_id>/', views.eliminar_unidad, name='eliminar_unidad'),
    path('intranet/flotilla/unidad/historial/<int:unidad_id>/', views.historial_unidad, name='historial_unidad'),
    path('intranet/flotilla/historial/', views.admin_historial_vehiculos, name='admin_historial_vehiculos'),
    path('intranet/flotilla/historial/imprimir/', views.imprimir_reporte_historial_vehicular, name='imprimir_reporte_historial_vehicular'),
    path('intranet/flotilla/reportes/', views.vista_impresion_reportes_jefe, name='vista_impresion_reportes_jefe'),
    path('intranet/flotilla/reportes/imprimir/', views.imprimir_reporte_movimiento_vehicular, name='imprimir_reporte_movimiento_vehicular'),
    path('intranet/flotilla/usuario/estado/<int:usuario_id>/<str:nuevo_estado>/', views.cambiar_estado_usuario, name='cambiar_estado_usuario'),

    # Rutas legacy compatibles
    path('control-vehiculos/admin/', views.admin_vehiculos_dashboard),
    path('control-vehiculos/admin/unidad/crear/', views.crear_unidad),
    path('control-vehiculos/admin/unidad/editar/<int:unidad_id>/', views.editar_unidad),
    path('control-vehiculos/admin/unidad/eliminar/<int:unidad_id>/', views.eliminar_unidad),
    path('control-vehiculos/admin/unidad/historial/<int:unidad_id>/', views.historial_unidad),
    path('control-vehiculos/admin/historial/', views.admin_historial_vehiculos),
    path('control-vehiculos/admin/historial/imprimir/', views.imprimir_reporte_historial_vehicular),
    path('control-vehiculos/admin/reportes/', views.vista_impresion_reportes_jefe),
    ...
    path('intranet/salidas/tv/', views.intranet_registro_salidas_tv, name='intranet_registro_salidas_tv'),
