...
urlpatterns = [
    ...
    path('control-vehiculos/admin/historial/', views.admin_historial_vehiculos, name='admin_historial_vehiculos'),
    path('control-vehiculos/admin/historial/imprimir/', views.imprimir_reporte_historial_vehicular, name='imprimir_reporte_historial_vehicular'),
    path('control-vehiculos/admin/reportes/', views.vista_impresion_reportes_jefe, name='vista_impresion_reportes_jefe'),
    path('control-vehiculos/admin/reportes/imprimir/', views.imprimir_reporte_movimiento_vehicular, name='imprimir_reporte_movimiento_vehicular'),
